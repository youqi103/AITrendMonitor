...
export async function verifyAuthenticity(title, content, source) {
...
export async function checkRelevance(keyword, title, content) {
...
export async function extractTrends(newsList) {
...
export async function generateSummary(title, content) {
    const systemPrompt = "你是一位专业的财经编辑。请用 1-2 句话概括以下新闻的核心内容，突出对股市的影响。";
...
export async function aggregateSummaries(newsList) {
